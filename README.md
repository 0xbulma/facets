...
>
> **Self-review every _facet_ of your PR — then ship it.** A local PR pipeline for Claude Code: plan the change, run a 17-agent review on your machine, apply the safe fixes, and open the PR — no cloud review bill.
...
│   │       └── scripts/                   # deterministic helpers, TypeScript run via node (changed-lines, finding validation)

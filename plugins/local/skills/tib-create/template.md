...
give the `/local:extract-plan` workflow a starting point for Linear milestones.
...
dependency audit, secrets handling). Skip if the decision has no security surface.

...
name: pr-create
version: 1.1.0
description: Create a draft PR (and a new branch if needed) from the current changes. Use when user says /facets:pr-create, "create a draft PR", "open a PR for these changes", "draft PR from this branch", or "push and open a draft". Derives title, description, branch name, and label from the diff — no questions asked.
---

# /facets:pr-create — Create a Draft PR
